                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="form" action="{{ url('application') }}" method="POST">@csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="App Name"
                                @if (isset($application->name)) value="{{ $application->name }}" @endif
                                value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="package_name" name="package_name"
                                ...
                                @if (isset($application->package_name)) value="{{ $application->package_name }}" @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="server_key" name="server_key"
                                ...
                                @if (isset($application->server_key)) value="{{ $application->server_key }}" @endif
